...
![photo 1](/dzvadzegh/python-project-2025/image1)
...
![alt text 2](/dzvadzegh/python-project-2025/image2)

1. ### **Какие задачи необходимо выполнить**

* Проектирование моделей User, Word, Stats, Checker  
* Создание структуры сервиса и модулей  
* Реализация database  
* Настройка scheduler  
* Команды: /start, /info, /stats, /add  
* Парсинг сообщений  
